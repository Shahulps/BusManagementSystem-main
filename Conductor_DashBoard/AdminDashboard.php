...
<head>
    ...
    <style>
        ...
        body {
            background: url("https://e1.pxfuel.com/desktop-wallpaper/339/215/desktop-wallpaper-panpan-0731-07-panpan.jpg") no-repeat center;
...
<body>
    ...
    <div class="main-block" style="width: 100%; margin: 0 auto; height: 100%;">
        ...
        <div class=" left-part">
            ...
            <div class="">
                <h3>Admin actions</h3>
                <a class="btn btn-item btn-block" style="width: 50%;" href="AddCon.php">Add Student</a>
            ...
            <div class="parent">
                ...
                <div class="child">
                    ...
                    <!--a class="btn btn-item btn-block" style="width: 55%;" href="quicktripsTriggerDisplay.php">Quick
                        Trips</a -->
                        <a class="btn btn-item btn-block" style="width: 55%;" href="321.html">Quick
                        Trips</a>

                    <!--a class="btn btn-item btn-block" style="width: 55%;" href="LossMakingTriggerDisplay.php">Loss
                        making Buses</a-->
                        <a class="btn btn-item btn-block" style="width: 55%;" href="321.html">Loss
                        making Buses</a>
                </div>
                ...
                <div class="child">
                    ...
                    <a class="btn btn-item btn-block" style="width: 57%;" href="321.html">VIEW STDNT/FCLTY
                    Detail</a>
