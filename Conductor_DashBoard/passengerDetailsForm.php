...
$sql = "SELECT bus_no FROM `bus_details`";
...
<body>
    ...
    <div class="maindiv" id="maindiv" style="width: 30%; padding:2%;">
        <form action="connect.php" method="post">
            <div class="title">
                <h2 class="text-center">Enter STDNT/FCLTY Details</h2>
            </div>
            <br>
            <div class="info">
                ...
                <div class="form-group">
                    ...
                    <select class="form-control" name="BusNumber" placeholder="BusNumber" required>
                        <?php
                ...
                <div class="form-group">
                    <label for="sstdnt/fclty id">ID</label>
                    <input class="form-control" type="number" id="tel" name="USERID" placeholder="USERID"
                        required>
                </div>
                ...
                <div class="form-group">
                    <label>enter Source Bus stop: </label>
                ...
                <div class="form-group">
                    <label>enter Destination Bus stop: </label>
                ...
                <div class="form-group">
                    ...
                    <input class="form-control" placeholder="FEE DETAILS" name="FEES" required >
                </div>
            </div>
