...
$sql = "INSERT INTO `trip_incharge`(`trip_no_incharge`,`Driver_emp_id`, `scheduled_dept_time`,`scheduled_arr_time`) 
  VALUES('$tripNO', '$did', '$sdep','$sarr')";//cid should be added after $did for retrieval of student number in their profile
