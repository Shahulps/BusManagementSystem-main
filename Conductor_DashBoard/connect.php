...
$sql = "INSERT INTO `passenger`(`trip_no_passenger`, `phone_no`, ``, `Passenger_source`, `Passenger_destination`, `ticket_price`)   VALUES('$TripNumber', '$PhoneNumber', '$TicketID', '$sourceChoice', '$destinationChoice', '$Ticketprice')";
