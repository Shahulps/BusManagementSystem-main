    ...
    <div class="maindiv" id="maindiv" style="width: 25%;">
        ...
        <form action="AddCon.php" method="post">
            <div class="title">
                ...
                <h2 class="text-center">Add STDNT/FCLTY Credentials</h2>
                <br>
            </div>

            <div class="form-group">
                <div class="form-group">
                    <label>STDNT/FCLTY ID: </label>
                    <input class="form-control" type="text" placeholder="STDNT/FCLTY ID" name="Cid" maxlength="4">
                </div>
                <div class="form-group">
...
// $con = mysqli_connect('localhost', 'database_user', 'database_password','database');
  ...
  VALUES('$cid', '$pwd')";
    ...
    if ($pwd != '') {
        echo "<script>alert('STDNT/FCLTY ADDED!')</script>";
    }
